...
for i0=3:3 %1:length(tmpd)
    ...
    [Is2,Bs]=ManualFitEvents_BackR(events,files{i0},2);
    [Is3,Bs]=ManualFitEvents_BackR(events,files{i0},3);
    [Sevents,SAs,SIs,SUppers,SLowers,SDrops]=ManuallySelectPhotobleaches23_Continue(events,As,Is2,Is3,Sevents,SAs,SIs,SUppers,SLowers,SDrops);
