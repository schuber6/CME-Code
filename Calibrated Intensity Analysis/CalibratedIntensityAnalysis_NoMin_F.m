function [MMI,LTs,ManI]=CalibratedIntensityAnalysis_NoMin_F(protein,i00)
...
%     %Good=[15 16 17 18]; %Best DNM cells
    ...
    newfiles{i0}=strcat(movies{i0}(1:end-4),'_Boxed','.tif');
    load(movies{i0});
    [MI,Fs,LTs,TraceFXY,TraceA]=FindGoodTraceMaxInts(Threshfxyc,0,50);
