function [VT,SA] = spread_cell_thresholding_ByStack_ThreshVolCell(filename,planes,TopPlane,BottomPlane) %Volume doesn't take top and bottom plane into account
%%
% if nargin < 1
...
%     end
    ...
    VT{i0}=CalculateThreshVolumeCell(masks);
    SA(i0)=CalculateThreshSurfaceArea(masks,BottomPlane,TopPlane);  
end
close(h)
end