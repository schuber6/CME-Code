function [FWHMs,XCR,isPlaque,shift_x,shift_y]=CorrelationAnalysis_FromTST(tracest,fileR,fileG)
...
for i=2:length(tracest)
    ...
    for i2=1:length(frames)
        ...
        [FWHMs{i,i2},XCR(i,i2),shift_x(i,i2),shift_y(i,i2)]=CorrelationAnalysis_Mats(GCrop{i,i2},RCrop{i,i2});
    end
end
close(h)