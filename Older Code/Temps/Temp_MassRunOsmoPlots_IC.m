...
ICWrapper
print(strcat(figpath,'_ICDensity'),'-djpeg')
PreInitDs=[PreInitDs PreInitD]; PreConcDs=[PreConcDs PreConcD];
PostInitDs=[PostInitDs PostInitD]; PostConcDs=[PostConcDs PostConcD];
PreAreas=[PreAreas PreArea];
PostAreas=[PostAreas PostArea]; close all
...
Reds=[Reds 1];
SHs=[SHs 1];
Parts=[Parts 0]; clear Threshfxyc
