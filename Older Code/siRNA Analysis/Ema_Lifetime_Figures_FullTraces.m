...
for i=1:length(SIpre)
    ...
    SIpreMS=[SIpreMS MSLT_EF{SIpre(i)}(:,2).'*2];
    end
end
WTpreMS=[];
for i=1:length(WTpre)
    if ~isempty(MSLT_EF{WTpre(i)})
    WTpreMS=[WTpreMS MSLT_EF{WTpre(i)}(:,2).'*2];
    end
end
SI3m66MS=[];
for i=1:length(SI3m66)
    if ~isempty(MSLT_EF{SI3m66(i)})
    SI3m66MS=[SI3m66MS MSLT_EF{SI3m66(i)}(:,2).'*2];
    end
end
WT3m66MS=[];
for i=1:length(WT3m66)
    if ~isempty(MSLT_EF{WT3m66(i)})
    WT3m66MS=[WT3m66MS MSLT_EF{WT3m66(i)}(:,2).'*2];
    end
end
...
for i=1:length(SI10m66)
    ...
    SI10m66MS=[SI10m66MS MSLT_EF{SI10m66(i)}(:,2).'*2];
    end
end
WT10m66MS=[];
for i=1:length(WT10m66)
    if ~isempty(MSLT_EF{WT10m66(i)})
    WT10m66MS=[WT10m66MS MSLT_EF{WT10m66(i)}(:,2).'*2];
    end
end
...
for i=1:length(SI3m80)
    ...
    SI3m80MS=[SI3m80MS MSLT_EF{SI3m80(i)}(:,2).'*2];
    end
end
WT3m80MS=[];
for i=1:length(WT3m80)
    if ~isempty(MSLT_EF{WT3m80(i)})
    WT3m80MS=[WT3m80MS MSLT_EF{WT3m80(i)}(:,2).'*2];
    end
end
...
for i=1:length(SI10m80)
    ...
    SI10m80MS=[SI10m80MS MSLT_EF{SI10m80(i)}(:,2).'*2];
    end
end
WT10m80MS=[];
for i=1:length(WT10m80)
    if ~isempty(MSLT_EF{WT10m80(i)})
    WT10m80MS=[WT10m80MS MSLT_EF{WT10m80(i)}(:,2).'*2];
    end
end
...
%%
C=CombineCells(PreC,P3m66C);
C=CombineCells(C,P10m66C);
figure
