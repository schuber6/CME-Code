...
folder='E:\CME Superfolder\CME Data\180412_SUM_CALM_AP2_GoodData\clathrin';
...
files=FindFiles(folder,'*osmo_d2*').';
for i=1:length(files)
    [Msd1,Ssd1,MM1,MS1,MI1,SI1,MSr1,N1]=OsmoshockParameters(files{i},5);
    Msd=[Msd ; Msd1];
    Ssd=[Ssd ; Ssd1];
    MM=[MM ; MM1];
    MS=[MS ; MS1];
