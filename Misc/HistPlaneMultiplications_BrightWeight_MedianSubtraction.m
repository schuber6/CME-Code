function [me,wme]=HistPlaneMultiplications_BrightWeight_MedianSubtraction(file) %Lists the division of the intensity of the pixel in plane i+1 divided by the pixel in plane i
