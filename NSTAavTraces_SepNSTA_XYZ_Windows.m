...
hold on
plot(AVtraceZ0,'Color',C+[0 0 1])
title('Average Value of Z Distance (Red: Post-Osmo, Green: Pre-Osmo)')
subplot(3,2,2)
plot(AVtraceZabs,'Color',C)
hold on
plot(AVtraceZabs0,'Color',C+[0 0 1])
title('Average Absolute Value of Z Distance (Red: Post-Osmo, Green: Pre-Osmo)')
subplot(3,2,3)
plot(AVtraceX,'Color',C)
hold on
title('Average Value of X Distance')
subplot(3,2,4)
plot(AVtraceXabs,'Color',C)
hold on
title('Average Absolute Value of X Distance')
subplot(3,2,5)
plot(AVtraceY,'Color',C)
hold on
title('Average Value of Y Distance')
subplot(3,2,6)
plot(AVtraceYabs,'Color',C)
hold on
title('Average Absolute Value of Y Distance')

xlabel('Frames from the end of the trace')
ylabel('Average Trace (Trace ends do not count in average)')
