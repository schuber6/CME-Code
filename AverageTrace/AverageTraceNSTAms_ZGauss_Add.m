function [Sample,BegMI,FinMI,BegMZ,FinMZ,BegSI,FinSI,BegSZ,FinSZ,BegAC,FinAC]=AverageTraceNSTAms_ZGauss_Add(NSTAms,BegMI,FinMI,BegMZ,FinMZ,BegSI,FinSI,BegSZ,FinSZ,BegAC,FinAC,display,Color)
