...
MaxIntVFrameWrapper;
print(strcat(figpath,'_MaxInt'),'-djpeg')
PreMaxInts=[PreMaxInts PreMaxInt];
PostMaxInts=[PostMaxInts PostMaxInt];
TotalMaxInts=[TotalMaxInts AvInt];
MaxIntFs=[MaxIntFs MaxIntF];
