...
for i=1:length(tmpd)
    ...
    fileFXYCstruct{i}=strcat(movies{i}(1:end-4),'_fxycMS.mat');
    MasterThresh=400;
    load(fileFXYC{i})
    [fxycMS]=GenerateMasterSlaveINTs_FXYC_0s_faster(Threshfxyc,SlaveMovies{i},MasterThresh,MasterMovies{i});
