function CompareAvTraces_EndAligned(fxycMScalm,fxycMSap2)

[InterM,InterS,MSDifs,MMcalm,MScalm,MDcalm]=PlotAvTraces_EndAligned(fxycMScalm);
close
[InterM,InterS,MSDifs,MMap2,MSap2,MDap2]=PlotAvTraces_EndAligned(fxycMSap2);
close
